...
How to use:
	...
	. Click deploy to deploy the application to the local folder Deployment/Synchronization in Logic
    . Copy the folder Deployment/Synchronization in Logic to the files folder of the CSWeb server
