...
separate menu application see the Listing Application With Maps example.
...
DeployListingWithMap containing all the required files. Simply copy this 
folder to the CSEntry folder of the mobile device. 
